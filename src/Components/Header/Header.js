...
const Header = () => {
    return (
        <header className='main'>
            ...
            <a className="navbar-brand" href="#"> <FontAwesomeIcon icon={faDesktop }/> E-Learning</a>
            ...
            <div className="main-header" >
                ...
                <h2 className='header-text'>The world's largest selection of courses</h2>
                <p className='header-para'>Choose from 150,000 online video courses with new additions published every month</p>
